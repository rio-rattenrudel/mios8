...
CS_MENU_DIN_TABLE
	;;		Function name		SR#	Pin#                                                                                            Original
	DIN_ENTRY	CS_MENU_BUTTON_Dec,	 2,	 6	; only valid if rotary encoder not assigned to these pins                               1,	 0
	DIN_ENTRY	CS_MENU_BUTTON_Inc,	 2,	 7	; (see MIOS_ENC_PIN_TABLE) and CS_MENU_USE_INCDEC_BUTTONS == 1                          1,	 1
	DIN_ENTRY	CS_MENU_BUTTON_Exec,	 4,	 4      ;                                                                                       1,	 2
	DIN_ENTRY	CS_MENU_BUTTON_Sel1,	 2,	 4      ;                                                                                       1,	 7
	DIN_ENTRY	CS_MENU_BUTTON_Sel2,	 4,	 0      ;                                                                                       1,	 6
	DIN_ENTRY	CS_MENU_BUTTON_Sel3,	 4,	 1      ;                                                                                       1,	 5
	DIN_ENTRY	CS_MENU_BUTTON_Sel4,	 4,	 2      ;                                                                                       1,	 4
	DIN_ENTRY	CS_MENU_BUTTON_Sel5,	 4,	 3      ;                                                                                       1,	 3
	...
	DIN_ENTRY	CS_MENU_BUTTON_Shift,	 0,	 0	; was: link button                                                                      2,	 4
	DIN_ENTRY	CS_MENU_BUTTON_CC_PageUp, 2,     5	; combined CC/PageUp -- CC actived together with shift button (no error)
	DIN_ENTRY	CS_MENU_BUTTON_Edit_PageDown, 0, 0	; combined Edit/PageDown -- Edit actived together with shift button (no error)          2,       6

	DIN_ENTRY	CS_MENU_BUTTON_Osc_Sel,	 4,	 7      ;                                                                                       4,	 2
	DIN_ENTRY	CS_MENU_BUTTON_Osc_Ctrl, 0,	 0      ;                                                                                       4,	 3
	DIN_ENTRY	CS_MENU_BUTTON_Osc_Wav,  0,	 0      ;                                                                                       4,	 4
	DIN_ENTRY	CS_MENU_BUTTON_Osc_RS,   0,	 0      ;                                                                                       4,	 5

 	DIN_ENTRY	CS_MENU_BUTTON_LFO_Sel,	 4,	 5      ;                                                                                       5,       2
	DIN_ENTRY	CS_MENU_BUTTON_LFO_Wav,	 5,	 3

	DIN_ENTRY	CS_MENU_BUTTON_Env_Sel,	 4,	 6      ;                                                                                       7,       2
...
CS_MENU_DOUT_TABLE
	;;		Register and bit			SR#	Pin#	  Description                                                           Original
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 0,		0,	0	; SID1 LED (Note: Pin #0 is the D7 output of first SR)          1,      0
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 1,		0,	7	; SID2 LED                                                      1,      1
	...
	DOUT_ENTRY	TMP3, 0,				0,	6	; Filter O1 LED                                                         3,      4
	DOUT_ENTRY	TMP3, 1,				0,	5	; Filter O2 LED                                                         3,	5
	DOUT_ENTRY	TMP3, 2,				0,	4	; Filter O3 LED                                                         3,	6
	DOUT_ENTRY	TMP3, 3,				0,	3	; Filter Ext LED                                                        3,	7
...
;;RIO_BGN
	DOUT_ENTRY	TMP4, 7,				0,	1	; SID R LED (TMP4, 7)
	DOUT_ENTRY	TMP4, 6,				0,	2	; SID L LED (TMP4, 6)
;;RIO_END
...
MIOS_ENC_PIN_TABLE
	;;        SR  Pin  Mode                                                                                                                         Original
#if CS_MENU_USE_INCDEC_BUTTONS == 0
	ENC_ENTRY  2,  6,  MIOS_ENC_MODE_DETENTED3	; menu encoder                                                                                  1,      0
#endif

	;; additional CS encoders
	;;        SR  Pin  Mode
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Osc delay/transpose/assign #1                                                                 3,      0
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Osc attack/finetune/assign #2                                                                 3,      2
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Osc decay/portamento/assign #3                                                                3,      4
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Osc sustain/release/assign #4                                                                 3,      6
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Osc release/pulsewidth/assign #5                                                              4,      0

	ENC_ENTRY  1,  6,  MIOS_ENC_MODE_DETENTED3	; LFO rate                                                                                      4,      6
	ENC_ENTRY  1,  4,  MIOS_ENC_MODE_DETENTED3	; LFO depth                                                                                     5,      0

	ENC_ENTRY  1,  2,  MIOS_ENC_MODE_DETENTED3	; Filter CutOff                                                                                 5,      4
	ENC_ENTRY  1,  0,  MIOS_ENC_MODE_DETENTED3	; Filter Resonance                                                                              5,      6

	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Env depth/assign #1                                                                           6,      0
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Env attack/assign #2                                                                          6,      2
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Env decay/assign #3                                                                           6,      4
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Env sustain/assign #4                                                                         6,      6
	ENC_ENTRY  0,  0,  MIOS_ENC_MODE_DETENTED3	; Env release/assign #5                                                                         7,      0
